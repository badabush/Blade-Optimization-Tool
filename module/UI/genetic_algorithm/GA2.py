...
class TestGA:
    def __init__(self):
        ...
        # Attribute generator
        attr_gen = list(self.toolbox.register("attr_%s" % i[3], random.uniform, float(i[0]), float(i[1])) for i in genes)

        # self.toolbox.register("attr_pp", random.uniform, 0.85, 0.95)
        # self.toolbox.register("attr_ao", random.uniform, -.1, .1)

        # self.toolbox.register("attr_item", random.randrange, 1, 100)
        ...
        self.toolbox.register("individual", tools.initCycle, creator.Individual,
                              (self.toolbox.attr_pp, self.toolbox.attr_ao, self.toolbox.attr_div,
                               self.toolbox.attr_alph1,
                               self.toolbox.attr_alph2, self.toolbox.attr_lambd, self.toolbox.attr_th,
                               self.toolbox.attr_xmaxth,
                               self.toolbox.attr_xmaxch, self.toolbox.attr_leth, self.toolbox.attr_teth),
                              n=1)
